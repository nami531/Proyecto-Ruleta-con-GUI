...
class Ruleta(): 
    ...
    def __init__(self) -> None: 
        ...
        self.puntero = 0 #El puntero siempre va a comenzar en la posición 0 
    ...
    # def generar_ruleta(self):  #Yo pienso que debe ir en el init, pq es cuando se inicializa
    #     premios = list(self.premios.keys())
    #     for i in range(25,0,-1): 
    #         posicion_añadida = False
    ...
    #             tipo_premio = random.randint(0,8)
    #             posicion = random.randint(0,i)
    #             if self.premios[premios[tipo_premio]] > 0:
    #                 self.ruleta.insert(posicion ,premios[tipo_premio] )
    #                 self.premios[premios[tipo_premio]] -=1 
    #                 posicion_añadida = True
    ...
    def girar(self, fuerza): 
        self.puntero =(self.puntero+ fuerza) % 25
        return self.puntero 
    
    def devuelve_posicion_puntero(self):
        return self.puntero 
